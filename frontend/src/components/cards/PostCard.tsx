...
export default function PostCard({forhome = false, view = "Card", postdetails} : PostCardProps) {
      ...
      <>
          <div className="flex w-full justify-between">
            ...
            <div className="flex w-[1/4] relative justify-center items-center mb-2">
              <button className="ps-4 pe-4 bg-[#A9A74F] hover:bg-[#A9A74F]/75 rounded-full text-xs h-8 justify-center items-center" onMouseEnter={() => {setIsHovered(true)}} onMouseLeave={() => {setIsHovered(false)}}>Join</button>
              <button ref={postMenuRef} className='font-bold ms-2 flex justify-center items-center h-10 w-10 bg-transparent rounded-full useinter text-sm hover:bg-[#30312f]' onClick={() => {setPostMenu(!postMenu)}} onMouseEnter={() => {setIsHovered(true)}} onMouseLeave={() => {setIsHovered(false)}}><DotsThree size={16}/></button>
              <AnimatePresence>
                {postMenu && (
          ...
          <div className="flex w-full">
            <div className="flex p-2 ps-3 pe-3 rounded-full bg-[#1a1b18] me-2 cursor-auto" onMouseEnter={() => {setIsHovered(true)}} onMouseLeave={() => {setIsHovered(false)}}>
            ...
            <div className="flex p-2 ps-3 pe-3 rounded-full bg-[#1a1b18] cursor-pointer hover:bg-[#383c34]" onMouseEnter={() => {setIsHovered(true)}} onMouseLeave={() => {setIsHovered(false)}}>
  ...
  return (
    <>
      {view === "Card" ? (
        !isHovered ? (
          <Link to={hoverLink} className="flex flex-col w-[360px] md:w-[600px] cursor-pointer hover:bg-[#1f211d] rounded-xl mb-3 p-2 useinter">
            {renderCard()}
          </Link>
        ) : (
        ...
        !isHovered ? (
          <Link to={hoverLink} className="flex flex-col w-[360px] md:w-[600px] md:h-[120px] sm:h-[200px] cursor-pointer hover:bg-[#1f211d] rounded-xl mb-3 p-2 useinter">
          {renderCompact()}
          </Link>
        ) : (
