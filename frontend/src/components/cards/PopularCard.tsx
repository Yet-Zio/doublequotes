...
export default function PopularCard({title, description, topquotepage, imgsrc} : PopularCardProps) {
  return (
    <Link to="/~memes"  className="flex flex-col-reverse w-[287px] h-[185px] bg-cover rounded-lg cursor-pointer" style={{backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.75)), url('${imgsrc}')`}}>
